  ...
  return (
    <div className="min-h-dvh pb-24 lg:pb-0">
      ...
      <div className="mx-auto flex max-w-7xl">
        <AdminNavigation labels={{ home: t["nav.home"], motorcycles: t["nav.motorcycles"], customers: t["nav.customers"], sales: t["nav.sales"], add: t["nav.add"], settings: t["nav.settings"] }} />
