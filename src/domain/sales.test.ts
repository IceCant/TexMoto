...
describe("reservation and sale rules", () => {
  ...
  it("parses money without floating point arithmetic in persistence", () => expect(parseSaleInput({ name: "Dara", phone: "012345678", sellingPrice: "2280.00", paymentMethod: "KHQR" }).sellingPrice).toBe(2280));
